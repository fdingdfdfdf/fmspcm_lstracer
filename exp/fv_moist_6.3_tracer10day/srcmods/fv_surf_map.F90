 module fv_surf_map_mod
      ...
      use constants_mod,     only: grav, datadir
...
!                      binary
      integer           ::  nlon = 10800
      integer           ::  nlat =  5400
      character(len=128)::  surf_file = "/n/home01/fdingdfdfdf/lbldata/mars-reverse.nc"
