module fv_eta_mod
 use constants_mod,  only: kappa, grav, cp_air, rdgas, ps0
...
!DF
  subroutine df_spacing(km, ak, bk)
     integer, intent(in) :: km
     real, intent(out) :: ak(km+1)
     real, intent(out) :: bk(km+1)
