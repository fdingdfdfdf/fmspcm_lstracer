...
character(len=50), public, save :: datadir='~/lbldata/'
  !character(len=40), save :: datadir='/Users/robin/programs/PCM_LBL/data/'
real, public, save    :: PS0    = 1e5
real, public, save    :: RADIUS = 6371.0e3   
integer, public, save :: nS     = 200 !2000        ! spectral resolution (same in sw and lw for now)
integer, public, save :: deltat_rad = 14400
real, public, save    :: OMEGA  = 7.292e-5 !/1.03 !365. 

real, public, parameter :: GRAV   = 9.80 !3.72 !9.80 !*1.204  

real, public, parameter :: mu_H2O = 18.01528  
real, public, parameter :: mu_CO2 = 44.0095      ! molar mass of CO2 [g/mol]
real, public, parameter :: CP_CO2 = 820.  
real, public, parameter :: mu_O2  = 32.0         ! molar mass of O2 [g/mol]
real, public, parameter :: cp_O2 = 34.0 / (mu_O2 * 1e-3) !J/mol/K

real, public, parameter :: Rstar  = 8.3144621       ! ideal gas constant [J/mol/K]
!real, public, parameter :: RDGAS  = Rstar / (mu_O2*1e-3)
!real, public, parameter :: CP_AIR = 1062.5
...
! FDing, 180119
  ...
  real, public, parameter :: losch  = 2.6867774d19    ! Loschmidt's number [molecules cm^-3]
